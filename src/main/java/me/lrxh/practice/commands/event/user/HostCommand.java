package me.lrxh.practice.commands.event.user;
...
public class HostCommand extends BaseCommand {
    ...
    @Subcommand("help")
    @CommandPermission("practice.admin.event")
    public void help(Player player) {
        for (String line : Practice.getInstance().getMainConfig().getStringList("EVENT.HELP")) {
